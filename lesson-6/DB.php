...
class DB
{
     ...
     * @return PDOStatement
     */
    //принимает на вход ($sql) любой $sql-запрос и ($args) массив, в который нужно подставить какому маркеру соответствует какое значение
